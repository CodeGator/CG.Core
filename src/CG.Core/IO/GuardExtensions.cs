        ...
        if (!argValue.CanRead)
        {
            ...
            throw new ArgumentException(
                message: string.Format(
                    ...
                    CG.Core.Properties.Resources.Guard_ArgNotReadable,
                    memberName,
                    sourceFilePath,
                    sourceLineNumber
                    ),
        ...
        )
    {
            ...
            Path.GetDirectoryName(argValue).IndexOfAny(Path.GetInvalidPathChars(), 0) != -1)
        {
            ...
            throw new ArgumentException(
                message: string.Format(
                    CultureInfo.CurrentCulture,
                    CG.Core.Properties.Resources.Guard_InvalidFilePath,
                    memberName,
                    sourceFilePath,
                    sourceLineNumber
                    ),
        ...
        )
    {
        ...
        if (argValue.IndexOfAny(Path.GetInvalidPathChars(), 0) != -1)
        {
            ...
            throw new ArgumentException(
                message: string.Format(
                    CultureInfo.CurrentCulture,
                    CG.Core.Properties.Resources.Guard_InvalidFolderPath,
                    memberName,
                    sourceFilePath,
                    sourceLineNumber
                    ),
        ...
        )
    {
            ...
            Path.GetExtension(argValue).IndexOfAny(Path.GetInvalidFileNameChars(), 0) != -1)
        {
            ...
            throw new ArgumentException(
                message: string.Format(
                    CultureInfo.CurrentCulture,
                    CG.Core.Properties.Resources.Guard_InvalidExtension,
                    memberName,
                    sourceFilePath,
                    sourceLineNumber
                    ),
        ...
        )
    {
        ...
        if (!argValue.CanWrite)
        {
            ...
            throw new ArgumentException(
                message: string.Format(
                    CultureInfo.CurrentCulture,
                    CG.Core.Properties.Resources.Guard_ArgNotWritable,
                    memberName,
                    sourceFilePath,
                    sourceLineNumber
                    ),
